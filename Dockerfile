...
FROM ${B19_GO_BASE_IMAGE} AS projectfile-bridge-builder
...
COPY --chown=${B19_UID}:${B19_GID} cmd/                             ${B19_HOME}/cmd/
...
FROM ${B19_UBUNTU_BASE_IMAGE} AS projectfile-bridge
...
COPY --from=projectfile-bridge-builder /export /
