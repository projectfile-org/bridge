...
[English](SECURITY.md) · [Español](docs/es/SECURITY.md)
...
Ми прагнемо підтвердити отримання повідомлення протягом 30 days і
...
Projectfile Bridges наразі не має програми винагород за вразливості. Проте ми цінуємо
