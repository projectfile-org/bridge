...
>
> - Dale una estrella al proyecto en [github.com](https://github.com/projectfile-org/bridge)
...
- Para ver si otras personas han tenido (y quizá ya resuelto) el mismo problema, comprueba que no exista ya un informe de tu fallo o error en el [gestor de incidencias](https://github.com/projectfile-org/bridge/issues?q=label%3Abug).
...
Usamos [Issues de GitHub](https://github.com/projectfile-org/bridge/issues) para seguir fallos y errores. Si te topas con un problema en el proyecto:

- Abre una [incidencia](https://github.com/projectfile-org/bridge/issues/new). (Como todavía no podemos saber si se trata de un fallo, te pedimos que no lo des por hecho ni etiquetes la incidencia.)
...
- Haz una [búsqueda](https://github.com/projectfile-org/bridge/issues) para ver si ya se ha propuesto. Si es así, comenta en la incidencia existente en lugar de abrir una nueva.
...
- **Explica por qué esta mejora sería útil** para quienes usan Projectfile Bridges. También puedes señalar otros proyectos que lo hayan resuelto mejor y que sirvan de inspiración.
